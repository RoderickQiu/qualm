...
The long version of the [README](../README.md): what each part does, setup in full, the
commands, the numbers and what stays on your Mac.
...
- **Checks in instead of counting a daily budget.** For entertainment video and social media,
  ...
  a little longer, up to a minute. It never blocks. [POLICY.md](POLICY.md) says why
  daily budgets were the wrong design.

<p align="center">
<img src="assets/panel-checkin.png" width="410" alt="Check in: what are you here for, and for how long?">
<img src="assets/panel-timesup.png" width="410" alt="The time you chose is up">
</p>
...
<p align="center">
<img src="assets/focus-prompt.png" width="360" alt="What are you here to do?">
<img src="assets/panel-focus.png" width="460" alt="You're here to: write the pitch deck.">
</p>
...
<p align="center"><img src="assets/dashboard-today.png" width="720" alt="Today, with a focus session running"></p>

<details><summary>In dark mode</summary>
<p align="center"><img src="assets/dashboard-today-dark.png" width="720" alt="Today, in dark mode, with a focus session running"></p>
</details>
...
**The app.** Download `Qualm.dmg` from [Releases](https://github.com/RoderickQiu/qualm/releases), or
build it (below). Drag Qualm to Applications and open it from there, not from the disk image. It's ad-hoc signed, not
...
Qualm is a desktop take on [SeeNot](https://github.com/RoderickQiu/seenot-app), an Android research app from SUSTech. It's built on
